...
$connection->exec('CREATE TABLE IF NOT EXISTS rounds (id TEXT PRIMARY KEY, slug TEXT UNIQUE, participant_digest BLOB, access_version INTEGER, admin_digest BLOB, admin_version INTEGER)');
...
if ((int) $connection->query('SELECT COUNT(*) FROM rounds')->fetchColumn() === 0) {
    ...
    $round = $connection->prepare('INSERT INTO rounds (id, slug, participant_digest, access_version, admin_digest, admin_version) VALUES (:id, :slug, :digest, 1, :admin_digest, 1)');
